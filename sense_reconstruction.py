...
# def perform_sense_recon_generalized(k_undersampled, coil_sensitivities, acquired_indices, save_nifti=False):
#     """
...
#         save_path_orig = "/Users/marioknicola/MSc Project/Dynamic_SENSE"
#         os.makedirs(save_path_orig, exist_ok=True)
#         filename_orig = os.path.join(save_path_orig, f"sense_recon_{Ny}x{Nx}x{Nf}.nii.gz")
        
#         # Save magnitude image
#         data_to_save_orig = np.abs(reconstructed_image_all_frames)
...
#         pad_Ny, pad_Nx = 410, 312
#         save_path_pad = "/Users/marioknicola/MSc Project/Dynamic_SENSE_padded"
#         os.makedirs(save_path_pad, exist_ok=True)
#         filename_pad = os.path.join(save_path_pad, f"sense_recon_padded_{pad_Ny}x{pad_Nx}x{Nf}.nii.gz")
...
#         # Create padded k-space array
#         kspace_padded = np.zeros((pad_Ny, pad_Nx, Nf), dtype=np.complex128)
        
#         # Calculate padding and insertion indices
...
#         # Insert original k-space into the center
...
#         # Save magnitude of padded image
#         data_to_save_pad = np.abs(image_padded)
...
#     # 2. Load Data
#     print("Loading data...")
#     kspace = loadmat('kspace_mat_US/kspace_Subject0023_mo.mat')['kspace'] 
#     coilmap  = loadmat('sensitivity_maps/sens_Subject0023_Exam17698_80x82x100_nC22.mat')['coilmap'] 
...
#     # Set save_nifti=True to enable saving
